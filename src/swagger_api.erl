...
request_params('ApiKycsCallbackProviderPost') ->
    [
    ];

request_params('ApiKycsCodePost') ->
    [
    ];

request_params('ApiKycsInitPost') ->
    [
    ];


request_params('ApiKycsIdPut') ->
    [
        'id'
    ];

request_params('ApiKycsIsvalidUserIdGet') ->
    [
        'userId'
    ];

request_params('ApiKycsPost') ->
    [
    ];

request_params('ApiKycsSignatureUserIdGet') ->
    [
        'userId'
    ];
...
request_param_info('ApiKycsIdPut', 'id') ->
    #{
        source =>  binding ,
        rules => [
            required
...
request_param_info('ApiKycsIsvalidUserIdGet', 'userId') ->
    #{
        source =>  binding ,
        rules => [
            required
...
request_param_info('ApiKycsSignatureUserIdGet', 'userId') ->
    #{
        source =>  binding ,
        rules => [
            required
...
validate_response('ApiKycsCallbackProviderPost', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);

validate_response('ApiKycsCodePost', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);

validate_response('ApiKycsInitPost', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);


validate_response('ApiKycsIdPut', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('ApiKycsIdPut', 500, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);

validate_response('ApiKycsIsvalidUserIdGet', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('ApiKycsIsvalidUserIdGet', 500, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);

validate_response('ApiKycsPost', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('ApiKycsPost', 500, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);

validate_response('ApiKycsSignatureUserIdGet', 200, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('ApiKycsSignatureUserIdGet', 500, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
